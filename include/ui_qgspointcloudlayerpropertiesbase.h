...
public:
    ...
    void setupUi(QDialog *QgsPointCloudLayerPropertiesBase)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/themes/default/propertyicons/editmetadata.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem2 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem2->setIcon(icon2);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/themes/default/algorithms/mAlgorithmBasicStatistics.svg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *QgsPointCloudLayerPropertiesBase)
    {
        ...
        ___qlistwidgetitem2->setText(QCoreApplication::translate("QgsPointCloudLayerPropertiesBase", "Metadata", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem2->setToolTip(QCoreApplication::translate("QgsPointCloudLayerPropertiesBase", "Metadata", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem3 = mOptionsListWidget->item(3);
        ___qlistwidgetitem3->setText(QCoreApplication::translate("QgsPointCloudLayerPropertiesBase", "Statistics", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem3->setToolTip(QCoreApplication::translate("QgsPointCloudLayerPropertiesBase", "Statistics", nullptr));
#endif // QT_CONFIG(tooltip)
