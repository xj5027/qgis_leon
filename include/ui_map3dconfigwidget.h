...
public:
    ...
    void setupUi(QWidget *Map3DConfigWidget)
    {
        ...
        scrollAreaCameraSkyboxWidgetContents->setGeometry(QRect(0, 0, 234, 220));
    ...
    void retranslateUi(QWidget *Map3DConfigWidget)
    {
        ...
        ___qlistwidgetitem->setText(QCoreApplication::translate("Map3DConfigWidget", "Terrain", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem->setToolTip(QCoreApplication::translate("Map3DConfigWidget", "Terrain settings", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem1 = m3DOptionsListWidget->item(1);
        ___qlistwidgetitem1->setText(QCoreApplication::translate("Map3DConfigWidget", "Lights", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem1->setToolTip(QCoreApplication::translate("Map3DConfigWidget", "Lights settings", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem2 = m3DOptionsListWidget->item(2);
        ___qlistwidgetitem2->setText(QCoreApplication::translate("Map3DConfigWidget", "Shadow", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem2->setToolTip(QCoreApplication::translate("Map3DConfigWidget", "Shadow settings", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem3 = m3DOptionsListWidget->item(3);
        ___qlistwidgetitem3->setText(QCoreApplication::translate("Map3DConfigWidget", "Camera & Skybox", nullptr));
#if QT_CONFIG(tooltip)
        ...
        label_12->setText(QCoreApplication::translate("Map3DConfigWidget", "Terrain elevation offset", nullptr));
