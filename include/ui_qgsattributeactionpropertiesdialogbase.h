...
public:
    ...
    void retranslateUi(QDialog *QgsAttributeActionPropertiesDialogBase)
    {
        ...
        textLabel1->setWhatsThis(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Enter the name of an action here. The name should be unique (QGIS will make it unique if necessary).", nullptr));
...
#if QT_CONFIG(tooltip)
        mBrowseButton->setToolTip(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Browse for action", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        mBrowseButton->setStatusTip(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Click to browse for an action", nullptr));
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        mBrowseButton->setWhatsThis(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Clicking the button will let you select an application to use as the action", nullptr));
#endif // QT_CONFIG(whatsthis)
        mBrowseButton->setText(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "\342\200\246", nullptr));
        label_4->setText(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "<html><head/><body><p>The action text defines what happens if the action is triggered.<br/>The content depends on the type.<br/>For the type <span style=\" font-style:italic;\">Python</span> the content should be python code<br/>For other types it should be a file or application with optional parameters</p></body></html>", nullptr));
        ...
        mActionType->setItemText(0, QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Generic", nullptr));
        mActionType->setItemText(1, QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Python", nullptr));
...
#if QT_CONFIG(tooltip)
        mActionName->setToolTip(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Enter the action name here", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        mActionName->setWhatsThis(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Enter the name of an action here. The name should be unique (QGIS will make it unique if necessary).", nullptr));
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        mCaptureOutput->setToolTip(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Captures any output from the action", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        mCaptureOutput->setWhatsThis(QCoreApplication::translate("QgsAttributeActionPropertiesDialogBase", "Captures the standard output or error generated by the action and displays it in a dialog box", nullptr));
#endif // QT_CONFIG(whatsthis)
