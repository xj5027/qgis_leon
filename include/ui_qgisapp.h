...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon187;
        icon187.addFile(QString::fromUtf8(":/images/themes/default/mActionCreateAnnotationLayer.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionCreateAnnotationLayer->setIcon(icon187);
        ...
        QIcon icon188;
        icon188.addFile(QString::fromUtf8(":/images/themes/default/mActionSelect.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionModifyAnnotation->setIcon(icon188);
