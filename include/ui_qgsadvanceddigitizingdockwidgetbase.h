...
public:
    ...
    void setupUi(QgsDockWidget *QgsAdvancedDigitizingDockWidgetBase)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/themes/default/cadtools/delta.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mRelativeYButton->setIcon(icon6);
        ...
        mRelativeAngleButton->setIcon(icon6);
        ...
        mRelativeMButton->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/themes/default/locked_repeating.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mRepeatingLockMButton->setIcon(icon7);
        ...
        mRepeatingLockXButton->setIcon(icon7);
        ...
        mRepeatingLockDistanceButton->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/themes/default/cadtools/lock.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mLockXButton->setIcon(icon8);
        ...
        mRelativeZButton->setIcon(icon6);
        ...
        mLockAngleButton->setIcon(icon8);
        ...
        mRepeatingLockZButton->setIcon(icon7);
        ...
        mLockDistanceButton->setIcon(icon8);
        ...
        mRepeatingLockAngleButton->setIcon(icon7);
        ...
        mRelativeXButton->setIcon(icon6);
        ...
        mRepeatingLockYButton->setIcon(icon7);
