...
public:
    ...
    {
        QgsModelDesignerDialogBase->setWindowTitle(QCoreApplication::translate("QgsModelDesignerDialogBase", "Graphical Modeler", nullptr));
        mActionOpen->setText(QCoreApplication::translate("QgsModelDesignerDialogBase", "Open Model\342\200\246", nullptr));
#if QT_CONFIG(tooltip)
        mActionOpen->setToolTip(QCoreApplication::translate("QgsModelDesignerDialogBase", "Open model (Ctrl+O)", nullptr));
...
#if QT_CONFIG(tooltip)
        mActionSave->setToolTip(QCoreApplication::translate("QgsModelDesignerDialogBase", "Save model (Ctrl+S)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        mActionSaveAs->setToolTip(QCoreApplication::translate("QgsModelDesignerDialogBase", "Save model as (Ctrl+S)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        mActionRun->setToolTip(QCoreApplication::translate("QgsModelDesignerDialogBase", "Run model (F5)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
