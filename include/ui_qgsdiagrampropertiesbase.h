...
#include "gui/effects/qgseffectstackpropertieswidget.h"
...
public:
    ...
    void setupUi(QWidget *QgsDiagramPropertiesBase)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/themes/default/legend.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/themes/default/mIconExpression.svg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    {
#if QT_CONFIG(tooltip)
        mEngineSettingsButton->setToolTip(QCoreApplication::translate("QgsDiagramPropertiesBase", "Automated placement settings (apply to all layers)", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        mIncreaseSmallDiagramsCheck->setText(QCoreApplication::translate("QgsDiagramPropertiesBase", "Increase size of small diagrams", nullptr));
