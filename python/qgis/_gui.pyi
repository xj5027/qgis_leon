...
class QgsColorButton(QtWidgets.QToolButton):
    ...
    def colorClicked(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor]) -> None: ...
...
class QgsColorDialog(QtWidgets.QDialog):
    ...
    @staticmethod
    def getColor(initialColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], parent: QtWidgets.QWidget, title: str = ..., allowOpacity: bool = ...) -> QtGui.QColor: ...
    def setAllowOpacity(self, allowOpacity: bool) -> None: ...
...
class QgsColorSchemeModel(QtCore.QAbstractItemModel):
    ...
    def __init__(self, scheme: _core.QgsColorScheme, context: str = ..., baseColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ..., parent: typing.Optional[QtCore.QObject] = ...) -> None: ...

    def isDirty(self) -> bool: ...
    def addColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], label: str = ..., allowDuplicate: bool = ...) -> None: ...
    def baseColor(self) -> QtGui.QColor: ...
    def context(self) -> str: ...
    def setScheme(self, scheme: _core.QgsColorScheme, context: str = ..., baseColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ...) -> None: ...
...
class QgsColorSchemeList(QtWidgets.QTreeView):
    ...
    def __init__(self, parent: typing.Optional[QtWidgets.QWidget] = ..., scheme: typing.Optional[_core.QgsColorScheme] = ..., context: str = ..., baseColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ...) -> None: ...
...
class QgsColorWidget(QtWidgets.QWidget):
    ...
    @staticmethod
    def transparentBackground() -> QtGui.QPixmap: ...
    def alterColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], component: 'QgsColorWidget.ColorComponent', newValue: int) -> None: ...
    def hue(self) -> int: ...
    @typing.overload
...
class QgsMapCanvas(QtWidgets.QGraphicsView, _core.QgsExpressionContextGenerator):
    ...
    def flashGeometries(self, geometries: typing.Iterable[_core.QgsGeometry], crs: _core.QgsCoordinateReferenceSystem = ..., startColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ..., endColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ..., flashes: int = ..., duration: int = ...) -> None: ...
    def flashFeatureIds(self, layer: _core.QgsVectorLayer, ids: typing.Any, startColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ..., endColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ..., flashes: int = ..., duration: int = ...) -> None: ...
    @typing.overload
...
class QgsMapLayerAction(QtWidgets.QAction):
    ...
    class Targets(PyQt5.sip.wrapper):
...
class QgsMapToolCapture(QgsMapToolAdvancedDigitizing):
    ...
    class CaptureTechnique(int):
        StraightSegments = ... # type: QgsMapToolCapture.CaptureTechnique
        CircularString = ... # type: QgsMapToolCapture.CaptureTechnique
        Streaming = ... # type: QgsMapToolCapture.CaptureTechnique
...
class QgsQueryBuilder(QgsSubsetStringEditorInterface):
    ...
    def reject(self) -> None: ...
    def accept(self) -> None: ...
    def codeEditorWidget(self) -> QtWidgets.QWidget: ...
    def setSubsetString(self, subsetString: str) -> None: ...
    def subsetString(self) -> str: ...
...
class QgsAbstractRelationEditorWidget(QtWidgets.QWidget):
    ...
    def addFeature(self, geometry: _core.QgsGeometry = ...) -> None: ...
...
class QgsSourceSelectProviderRegistry(PyQt5.sip.wrapper):
...
class QgsTextFormatWidget(QtWidgets.QWidget, _core.QgsExpressionContextGenerator):
    ...
    def setFormatFromStyle(self, name: str, type: _core.QgsStyle.StyleEntity) -> None: ...
...
class QgsProcessingParametersGenerator(PyQt5.sip.wrapper):
    ...
    def createProcessingParameters(self) -> typing.Dict[str, typing.Any]: ...
